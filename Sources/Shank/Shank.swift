...
public extension Module {
    ...
    func shared<T>(resolved object: @escaping () -> T) {
        Resolver.register(factory: object).scope(Resolver.application)
    }
    
    func make<T>(resolved object: @escaping () -> T) {
        Resolver.register(factory: object).scope(Resolver.unique)
    }
    
    func viewModel<T>(resolved object: @escaping () -> T) {
        Resolver.register(factory: object).scope(Resolver.unique)
    }
}
...
public extension Module {
    ...
    func viewController(resolved object: @escaping () -> UIViewController) {
        Resolver.register(factory: object).scope(Resolver.unique)
    }
}
#endif
...
public extension Module {
    ...
    func view<T: View>(resolved object: @escaping () -> T) {
        Resolver.register(factory: object).scope(Resolver.unique)
    }
}
#endif
